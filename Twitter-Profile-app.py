...
مهم: استخدم الروابط الفعلية من البيانات.
...
الرد بالعربية. نقاط مختصرة مع روابط."""
            content = generate_ai_section(gemini, section_key, prompt, 8000)
...
**السبب #1:**
- [سبب رئيسي للمدح أو النقد]
- التأثير: [مختصر]

**السبب #2:**
- [العوامل العاطفية/الاجتماعية]
- التأثير: [مختصر]
...
الرد بالعربية. نقاط مختصرة."""
            ...
            prompt = f"""أنت محلل أدلة. قدم أمثلة حقيقية.
...
مهم: استخدم فقط الروابط الموجودة أعلاه.
الرد بالعربية. نقاط + روابط."""
            content = generate_ai_section(gemini, section_key, prompt, 8000)
