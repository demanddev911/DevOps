...
def ai_detailed_report_page():
    ...
    for idx, (section_key, section_title, progress_val) in enumerate(sections):
        ...
        if section_key == "introduction":
            prompt = f"""أنت محلّل سمعة رقمية واستشاري تحسين الصورة العامة على تويتر/إكس.
...
المطلوب - اكتب الملخص التنفيذي (400-500 كلمة) يتضمن:

🧭 **الملخّص التنفيذي**

**الانطباع العام عن الحساب:** [إيجابي / سلبي / مختلط]

**درجة التأثير والتفاعل:** [مرتفع / متوسط / منخفض]

**أبرز المواضيع التي يتحدث عنها الجمهور:**
- [الموضوع الأول]
- [الموضوع الثاني]
- [الموضوع الثالث]
- [الموضوع الرابع]

**نوع الجمهور الأساسي:** [عملاء / متابعين عامّين / جمهور إعلامي / سياسي / تقني]

**الملخص العام:**
[فقرة توضح الحالة العامة للسمعة وأهم النقاط]

اكتب بأسلوب احترافي مباشر. لا تستخدم رموز إضافية.
الرد بالعربية الواضحة."""
            content = generate_ai_section(gemini, section_key, prompt, 6000)
            
        elif section_key == "what_people_say":
            prompt = f"""أنت محلل محتوى متخصص في تحليل آراء الجمهور.
...
المطلوب - اكتب قسماً كاملاً (800-1000 كلمة) بهذا التنسيق:

💬 **ماذا يقول الناس عن الحساب**

✅ **الجمهور يشيد بـ** [نقطة القوة أو السلوك الإيجابي]
🔗 **دليل:** [رابط التغريدة أو الرد الإيجابي من الروابط أعلاه]

✅ **كما يقدرون** [نقطة قوة أخرى]
🔗 **دليل:** [رابط آخر]

⚠️ **بعض المستخدمين يعبّرون عن استيائهم من** [نقطة الضعف أو المشكلة]
🔗 **دليل:** [رابط التغريدة النقدية]

⚠️ **هناك انتقادات حول** [مشكلة أخرى]
🔗 **دليل:** [رابط]

💬 **ملاحظات متكرّرة تتعلق بـ** [موضوع معين أو سلوك محدد]
🔗 **دليل:** [رابط الدليل أو المحادثة]

**مهم جداً:**
- استخدم الروابط الفعلية من التغريدات أعلاه
- كل نقطة يجب أن يكون معها رابط دليل
- اذكر 3-4 نقاط إيجابية و 3-4 نقاط سلبية

اكتب بأسلوب واضح ومباشر. الرد بالعربية."""
            content = generate_ai_section(gemini, section_key, prompt, 10000)
            
        elif section_key == "complaints_issues":
            prompt = f"""أنت خبير في تحليل الشكاوى والانتقادات.

التغريدات والتعليقات مع روابطها:
{evidence_text}
{chr(10).join([f"- {c[:150]}" for c in sample_comments_list[:150]]) if sample_comments_list else ""}

المطلوب - اكتب قسماً كاملاً (700-900 كلمة) بهذا التنسيق:

😟 **نقاط الشكوى أو الانتقاد المتكررة**

📍 **الشكوى الرئيسية الأولى:** [وصف الشكوى بالتفصيل]
🔗 **دليل:** [رابط التغريدة أو التعليق]
📊 **التكرار:** [كم مرة ذُكرت هذه الشكوى]

📍 **الشكوى الثانية:** [الجانب المثير للجدل]
🔗 **دليل:** [رابط أو مثال]
📊 **التكرار:** [معدل الذكر]

📍 **الشكوى الثالثة:** [ملاحظة إضافية من الجمهور]
🔗 **دليل:** [رابط أو تفاعل واقعي]
📊 **التكرار:** [معدل الذكر]

📍 **شكاوى أخرى أقل تكراراً:**
- [شكوى 4] 🔗 [رابط]
- [شكوى 5] 🔗 [رابط]

**التقييم:**
- **أخطر شكوى:** [اسم الشكوى ولماذا]
- **الأسهل للمعالجة:** [اسم الشكوى]

**مهم:** استخدم الروابط الفعلية من البيانات أعلاه.

اكتب بأسلوب تحليلي دقيق. الرد بالعربية."""
            content = generate_ai_section(gemini, section_key, prompt, 10000)
            
        elif section_key == "why_they_say":
            prompt = f"""أنت محلل نفسي وسلوكي متخصص في فهم دوافع الجمهور.
...
🧠 **تحليل أسباب الرأي العام**

**السبب الأول:** ما الذي يدفع الجمهور للمديح أو النقد؟
- [تفصيل السبب الأول]
- العوامل المؤثرة: [قائمة]

**السبب الثاني:** العوامل العاطفية أو الاجتماعية خلف المواقف
- [تفصيل السبب الثاني]
- التأثير: [وصف]

**السبب الثالث:** مدى تأثير نبرة المحتوى وطريقة الرد على الانطباع العام
- [تفصيل السبب الثالث]
- الملاحظات: [قائمة]

**الخلاصة:**
[فقرة تلخص الأسباب الجذرية للانطباع العام]

اكتب بأسلوب تحليلي عميق. الرد بالعربية."""
            content = generate_ai_section(gemini, section_key, prompt, 10000)
            
        elif section_key == "how_to_improve":
            prompt = f"""أنت مستشار سمعة رقمية وخبير في تحسين الصورة العامة.

التحليلات السابقة:
- ما يقوله الناس: {st.session_state.ai_report_cache.get('what_people_say', '')[:500]}
- الشكاوى: {st.session_state.ai_report_cache.get('complaints_issues', '')[:500]}
- الأسباب: {st.session_state.ai_report_cache.get('why_they_say', '')[:500]}

المطلوب - اكتب قسماً كاملاً (900-1100 كلمة) بهذا التنسيق:

💡 **ما الذي يمكن فعله لتحسين الصورة والانطباع العام**

**🎯 حلول قصيرة المدى (فورية خلال أيام):**

✅ [إجراء عملي واضح رقم 1 – مثل زيادة الردود على التعليقات السلبية]
   - كيفية التنفيذ: [خطوات]
   - المدة: [عدد الأيام]

✅ [نشر منشور توضيحي أو تصحيح سوء فهم]
   - كيفية التنفيذ: [خطوات]
   - المدة: [عدد الأيام]
...
**📅 حلول متوسطة المدى (خلال أسابيع):**

✅ [تحسين خطة المحتوى بناءً على تفاعل الجمهور]
   - التفاصيل: [وصف]
   - المدة: [أسابيع]

✅ [تطوير أسلوب التواصل ليكون أكثر وضوحًا وإنسانية]
   - التفاصيل: [وصف]
   - المدة: [أسابيع]

✅ [بناء مبادرات بسيطة لتعزيز العلاقة مع الجمهور]
   - التفاصيل: [وصف]
   - المدة: [أسابيع]

**🎯 حلول طويلة المدى (استراتيجية):**

✅ [إعادة بناء الصورة العامة عبر حملة اتصالية]
   - الخطة: [وصف مفصل]
   - المدة: [أشهر]

✅ [التعاون مع مؤثرين موثوقين لتحسين المصداقية]
   - الخطة: [وصف مفصل]
   - المدة: [أشهر]

✅ [تأسيس برنامج تفاعل مجتمعي يعزز الثقة]
   - الخطة: [وصف مفصل]
   - المدة: [أشهر]

**الأولوية:**
البدء بـ [الإجراء الأهم] لأن [السبب]

اكتب بأسلوب عملي قابل للتنفيذ. الرد بالعربية."""
            content = generate_ai_section(gemini, section_key, prompt, 12000)
            
        elif section_key == "positive_opportunities":
            prompt = f"""أنت خبير في اكتشاف الفرص الإيجابية والاستثمار في نقاط القوة.

البيانات:
{evidence_text}

المطلوب - اكتب قسماً كاملاً (600-800 كلمة) بهذا التنسيق:

🚀 **الفرص الإيجابية القابلة للاستثمار**

💎 **موضوعات تحظى بتفاعل إيجابي يمكن التوسع فيها:**
- [الموضوع الأول] - معدل التفاعل: [رقم]
- [الموضوع الثاني] - معدل التفاعل: [رقم]
- [الموضوع الثالث] - معدل التفاعل: [رقم]

📈 **محتوى يتسبب في تعزيز الولاء والثقة:**
- [نوع المحتوى الأول] - لماذا ينجح: [السبب]
- [نوع المحتوى الثاني] - لماذا ينجح: [السبب]

🧩 **شرائح جمهور جديدة يمكن استهدافها:**
- [الشريحة الأولى] - كيفية الوصول: [الطريقة]
- [الشريحة الثانية] - كيفية الوصول: [الطريقة]

💬 **مؤيدون أو حسابات مؤثرة تتفاعل إيجابياً:**
- @[اسم الحساب] - نوع التفاعل: [وصف]
- @[اسم حساب آخر] - نوع التفاعل: [وصف]

**استراتيجية الاستفادة:**
[فقرة تشرح كيفية الاستفادة من هذه الفرص]

اكتب بأسلوب إيجابي محفز. الرد بالعربية."""
            content = generate_ai_section(gemini, section_key, prompt, 10000)
            
        elif section_key == "evidence_examples":
            prompt = f"""أنت محلل بيانات متخصص في تقديم أمثلة واقعية مدعومة بالأدلة.

التغريدات مع روابطها:
{evidence_text}

التعليقات:
{chr(10).join([f"- {c[:100]}" for c in sample_comments_list[:100]]) if sample_comments_list else ""}

المطلوب - اكتب قسماً كاملاً (700-900 كلمة) بهذا التنسيق:

🧩 **أمثلة وتحليلات مدعومة بالأدلة**

💬 **الناس بتقول:**

**مثال 1:**
✅ "ردّه محترم وسريع دائمًا."  
🔗 [رابط التغريدة من البيانات أعلاه]
📊 التحليل: [ماذا يعني هذا للسمعة]

**مثال 2:**
⚠️ "ما بيرد غير بعد أيام، ده بيدايقنا."  
🔗 [رابط التغريدة من البيانات أعلاه]
📊 التحليل: [ماذا يعني هذا للسمعة]

**مثال 3:**
💬 "المواضيع الأخيرة كانت مثيرة للاهتمام."  
🔗 [رابط التغريدة من البيانات أعلاه]
...
**الخلاصة:**
[فقرة تلخص أهم الأمثلة وماذا تعني للسمعة]

**مهم جداً:**
- استخدم فقط الروابط الفعلية من البيانات المتوفرة
- اختر أمثلة متنوعة (إيجابية وسلبية)
- كل مثال يجب أن يكون له تحليل

اكتب بأسلوب واضح ومباشر. الرد بالعربية."""
            content = generate_ai_section(gemini, section_key, prompt, 10000)
            
        elif section_key == "monitoring_metrics":
            prompt = f"""أنت خبير في قياس الأداء ومتابعة التحسن.

المطلوب - اكتب قسماً كاملاً (600-800 كلمة) بهذا التنسيق:

📊 **المؤشرات المقترحة للمتابعة والتقييم**

🔹 **معدل التغير في التفاعل الإيجابي بعد تطبيق الحلول**
   - كيفية القياس: [الطريقة]
   - التردد: [يومي / أسبوعي / شهري]
   - الهدف: [رقم أو نسبة]

🔹 **انخفاض نسبة الانتقادات أو الشكاوى خلال الأسابيع التالية**
   - كيفية القياس: [الطريقة]
   - التردد: [يومي / أسبوعي / شهري]
   - الهدف: [رقم أو نسبة]

🔹 **عدد المرات التي ذُكر فيها الحساب بشكل إيجابي خلال الشهر القادم**
   - كيفية القياس: [الطريقة]
   - التردد: [يومي / أسبوعي / شهري]
   - الهدف: [رقم أو نسبة]

🔹 **تحسن ترتيب الحساب في شبكة التأثير (Mentions & Retweets)**
   - كيفية القياس: [الطريقة]
   - التردد: [يومي / أسبوعي / شهري]
   - الهدف: [رقم أو نسبة]

🔹 **معدل الاستجابة للتعليقات**
   - كيفية القياس: [الطريقة]
   - التردد: [يومي / أسبوعي / شهري]
   - الهدف: [رقم أو نسبة]

**📈 لوحة المتابعة المقترحة:**
يُنصح بمتابعة هذه المؤشرات الخمسة بشكل أسبوعي وإعداد تقرير شهري مفصل.
...
اكتب بأسلوب عملي قابل للتطبيق. الرد بالعربية."""
            content = generate_ai_section(gemini, section_key, prompt, 10000)
...
📈 محتوى يتسبب في تعزيز الولاء والثقة:
- [نوع المحتوى] - لماذا ينجح: [السبب]

🧩 شرائح جمهور جديدة يمكن استهدافها:
- [الشريحة] - كيفية الوصول: [الطريقة]
...
📈 لوحة المتابعة المقترحة:
يُنصح بمتابعة هذه المؤشرات بشكل أسبوعي وإعداد تقرير شهري مفصل.
